...
class Snake(Problem):
    ...
    def h(self,node):
        ...
        distances = [abs(goal_x - hx) + abs(goal_y - hy) for goal_x, goal_y in g_apples]
...
if __name__ == "__main__":
    ...
    initial_body = ((0, 7), (0, 8), (0, 9))  # Must be a tuple!
    initial_direction = 'S'

    initial_state = (initial_body, initial_direction, tuple(zeleni_jabolki))
    problem = Snake(initial_state)
