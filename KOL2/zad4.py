...
if __name__ == '__main__':
  ...
  new_record = [float(x) for x in input_line.split()]

  # List comprehension трик: ги земаме сите елементи до col_index и ги спојуваме со сите елементи по col_index
  ...
  filtered_new_record = new_record[:col_index] + new_record[col_index + 1 :]
  ...
  # Predviduvanje na noviot zapis
  pred_class = model.predict([filtered_new_record])[0]
  pred_proba = model.predict_proba([filtered_new_record])[0]
